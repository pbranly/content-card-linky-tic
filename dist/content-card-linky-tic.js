/* content-card-linky-tic.js
   Affiche les informations LINKY avec les données provenant de myElectricalData ou d'un ESPhome
*/
...
class ContentCardLinkyTic extends LitElement {
  ...
  static get styles() {
	...
	text-transform: capitalize;
      ...
      .tempo-table th { font-weight: bold; }
      .tempo-table td:nth-child(1) { text-align: left; }
      `;
  }
}
