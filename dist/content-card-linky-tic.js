...
// Index ESPHome Linky Tempo
const linkyTempoIndexBBRHCJW = this.hass.states[this.config.linkyTempoIndexBBRHCJW];
const linkyTempoIndexBBRHPJW = this.hass.states[this.config.linkyTempoIndexBBRHPJW];
const linkyTempoIndexBBRHCJB = this.hass.states[this.config.linkyTempoIndexBBRHCJB];
const linkyTempoIndexBBRHPJB = this.hass.states[this.config.linkyTempoIndexBBRHPJB];
const linkyTempoIndexBBRHCJR = this.hass.states[this.config.linkyTempoIndexBBRHCJR];
const linkyTempoIndexBBRHPJR = this.hass.states[this.config.linkyTempoIndexBBRHPJR];
      ...
      return html`
        <ha-card id="card">
          ...
          <div class="card">
            ...
            ${this.renderTempoIndex(linkyTempoIndexBBRHCJW, linkyTempoIndexBBRHPJW, linkyTempoIndexBBRHCJB, linkyTempoIndexBBRHPJB, linkyTempoIndexBBRHCJR, linkyTempoIndexBBRHPJR, this.config)}
...
renderTempoIndex(indexBBRHCJW, indexBBRHPJW, indexBBRHCJB, indexBBRHPJB, indexBBRHCJR, indexBBRHPJR, config) {
if (this.config.showTempoIndex === true) {
return html`<div class="tempo-index"> <div class="tempo-index-title">Index Tempo</div> <table class="tempo-index-table"> <tr> <td class="tempo-blue">Jours Bleus</td> <td>HC: ${indexBBRHCJB ? this.toFloat(indexBBRHCJB.state) : 'N/A'} kWh</td> <td>HP: ${indexBBRHPJB ? this.toFloat(indexBBRHPJB.state) : 'N/A'} kWh</td> </tr> <tr> <td class="tempo-white">Jours Blancs</td> <td>HC: ${indexBBRHCJW ? this.toFloat(indexBBRHCJW.state) : 'N/A'} kWh</td> <td>HP: ${indexBBRHPJW ? this.toFloat(indexBBRHPJW.state) : 'N/A'} kWh</td> </tr> <tr> <td class="tempo-red">Jours Rouges</td> <td>HC: ${indexBBRHCJR ? this.toFloat(indexBBRHCJR.state) : 'N/A'} kWh</td> <td>HP: ${indexBBRHPJR ? this.toFloat(indexBBRHPJR.state) : 'N/A'} kWh</td> </tr> </table> </div>`;
}
return html``;
}
